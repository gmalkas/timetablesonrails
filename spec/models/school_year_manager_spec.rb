...
describe SchoolYearManager do
  ...
  describe "#new_school_year" do
    ...
    it "can create a school year with a String year" do
      ...
      school_year.start.year.should == 2012
      school_year.end.year.should == 2013
    end

    it "can create a school year with an integer year" do
      school_year = SchoolYearManager.instance.new_school_year(@year)
      school_year.start.year.should == @year
      school_year.end.year.should == @year + 1
    end
    ...
    it "can create a school year with a Date" do
      ...
      school_year.start.should == date
      school_year.end.should == date.next_year
    end
